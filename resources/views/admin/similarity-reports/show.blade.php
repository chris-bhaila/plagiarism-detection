        ...
        <div class="mt-6 flex flex-wrap gap-7 items-start">
                        ...
                        <div class="bg-white border border-slate-300 rounded-sm">
                            ...
                            <div x-data="{ notesOpen: false }" class="border-t border-slate-200 px-5 py-3.5">
                                <div class="flex items-center justify-between gap-3 flex-wrap">
                                    ...
                                    <form method="POST" action="{{ route('admin.submissions.similarity-release.update', $submission) }}">
                                        @csrf
                                        @method('PATCH')
            ...
            <div class="flex-1 min-w-[260px] basis-[280px] sticky top-[84px] grid gap-5">
                ...
                <div class="bg-white border border-slate-300 rounded-sm p-5">
                    ...
                    <div class="mt-4 text-xs leading-relaxed text-slate-700">Status changes are visible to the course's teacher.</div>
                </div>
